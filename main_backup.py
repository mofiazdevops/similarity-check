...
def find_matching_phrases(source_text, target_text, n=3):
    """
...
def check_similarity():
    ...
    BASE_URL = "https://portalteam.org/user_uploads"
    ...
    for existing_file in os.listdir(ASSIGNMENT_DIR):
        ...
        if target_text:
            matching_phrases, similarity_percentage = find_matching_phrases(source_text, target_text, n=3)
            if matching_phrases:
                matches.append({
                ...
                total_sources += len(matching_phrases)
    ...
    callback_url = "https://portalteam.org/api/files/save-response"
